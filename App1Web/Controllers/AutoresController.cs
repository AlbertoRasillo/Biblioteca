...
namespace App1Web.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_autor,nombre,apellidos,año")] Autores autores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_autor,nombre,apellidos,año")] Autores autores)
        {
            if (ModelState.IsValid)
            {
